...
public interface IPersistenceManager
{
    ...
    List<ITags> findLike(String keyword);
    
    List<IDescription> findWidgetsLike(String keyword);
    <T> List<T> JPQLQuery(Class<T> bean , String queryString);
    
    IStoreUser getStoreUser(String username);
