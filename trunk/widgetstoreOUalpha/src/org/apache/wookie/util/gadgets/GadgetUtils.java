...
public class GadgetUtils {
	 ...
	 */
//	public static final String SHINDIG_SERVICE = "localhost:8080/";
	public static final String SHINDIG_SERVICE = "/";

	/**
	 * Relative URL of the Shindig metadata service
	 */
//	public static final String METADATA_SERVICE = "localhost:8080/gadgets/metadata/";
	...
	public static W3CWidget createWidget(HttpServletRequest request) throws Exception{
		...
		try {
			...
			if (properties.getString("widget.shindig.url")!=null) shindig = properties.getString("widget.shindig.url");
                        System.out.println("widget.metadata.url:"+svc);
                        System.out.println("widget.shindig.url:"+shindig);
		} catch (Exception e) {
		...
		//URL gadgetService = new URL(request.getScheme(),request.getServerName(),
                //        request.getServerPort() , svc);
                URL gadgetService = new URL("http://localhost:12345/gadgets/metadata");
                
		
		//URL gadgetService = new URL("http://"+svc);
		
		System.out.println("URL gadgetSerive:"+gadgetService.toString());
		System.out.println("request.getParameter(\"url\"):"+request.getParameter("url"));
	...
	public static W3CWidget getWidget(String metadata, String shindig) throws Exception{
		...
		System.out.println("getWidget() gadget:"+gadget);
		System.out.println("shindig string :"+shindig);
