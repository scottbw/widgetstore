...
public interface IWidgetAPI {	
	...
	/**
	 * Returns a map containing widget coupling attributes which
	 * can be used to find matching widget instances. Set of
	 * attributes must be specified in widgetserver.properties.
	 * @param widgetInstance - coupling widgets are searched based on this widget instance
