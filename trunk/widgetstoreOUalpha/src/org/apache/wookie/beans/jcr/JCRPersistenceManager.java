...
public class JCRPersistenceManager implements IPersistenceManager
{
    ...
    @Override
    public List<ITags> findLike(String tagText){return null;}

    public IStoreUser getStoreUser(String username){return null;}

    public List<IDescription> findWidgetsLike(String keyword) {return null;}
    
    public EntityManager getEntityManager(){return null;}

    public <T> List<T> JPQLQuery(Class<T> bean , String queryString){return null;}
}
