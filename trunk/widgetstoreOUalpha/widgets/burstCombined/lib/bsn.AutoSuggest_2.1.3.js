...
/* modified for the purposes of burst search widget */
...
_b.AutoSuggest.prototype.setSuggestions = function (req, input)
{
    ...
    if (this.oP.json)
    {
        ...
        {
            this.aSug.push(  {
                'id':jsondata.documents[i]["rdf.person.about"],
                'value':jsondata.documents[i]["rdf.person.name"],
                'info':jsondata.documents[i].info
            } );
        }
    }
    else
